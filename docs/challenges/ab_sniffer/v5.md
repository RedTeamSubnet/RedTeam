...
Example codes for AB Sniffer v5 can be found in the [`detections`](https://github.com/RedTeamSubnet/ab-sniffer-challenge/tree/main/src/templates/static/detections) directory.
...
After completing your implementation, follow the [Building a Submission Commit](../../miner/building-commit.md) guide to package and submit your solution.
