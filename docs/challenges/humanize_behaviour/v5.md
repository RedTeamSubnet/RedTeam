...
Example codes for Humanize Behaviour v5 can be found in the [`/src/bot`](https://github.com/RedTeamSubnet/humanize-behaviour-challenge/tree/main/src/bot) directory.

### Core Requirements

1. Use our template from [`/src/core/bot.py`](https://github.com/RedTeamSubnet/miner/blob/main/examples/humanize_behaviour_v5/src/bot/bot.py)
