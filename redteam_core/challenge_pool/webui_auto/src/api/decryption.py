...
from cryptography.exceptions import UnsupportedAlgorithm, AlreadyFinalized, InvalidSignature, NotYetFinalized, AlreadyUpdated, InvalidKey, InvalidTag
...
from api.helpers.crypto.asymmetric_keys import decrypt_with_private_key
...
class DecryptPayload:
    ...
    def decrypt(self, encrypted_payload: str) -> Any:
        encrypted_aes_key, encrypted_iv, encrypted_data = self._parse_payload(encrypted_payload)
