...
class Controller:
    ...
    def _get_challenge_from_container(self) -> dict:
        """
        Retrieves a challenge input from the running challenge container by making an HTTP GET request.
        ...
        for attempt in range(3):
            try:
                ...
                if attempt == 2:
                    raise RuntimeError(f"Failed to retrieve challenge from container after 3 attempts: {e}")
