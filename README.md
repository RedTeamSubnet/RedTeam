...
3. **Fallback Mechanism**: When challenge gets inactive in case where there is no valid submission in a challenge, all weights will be directed to burn. This logic maintains fairness and keeps subnet value stable.
